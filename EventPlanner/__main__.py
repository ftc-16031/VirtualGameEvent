...
class EventPlanner(QtWidgets.QMainWindow):
    ...
    def match_manifest(self, match):
        ...
        teams.append({'TeamName': team['name'], 'TeamNumber': team['number'], 'Alliance': 'Red', 'GameVideo': {'Location': f'{match_video_filename}', 'VideoManifest': f'{video_manifest_filename}'}})
        ...
        match_video_filename = os.path.normpath(os.path.join(match_folder, f'{match_file_prefix}.mp4'))
        video_manifest_filename = os.path.normpath(os.path.join(match_folder, f'{match_file_prefix}.yml'))
        teams.append({'TeamName': team['name'], 'TeamNumber': team['number'], 'Alliance': 'Blue', 'GameVideo': {'Location': f'{match_video_filename}', 'VideoManifest': f'{video_manifest_filename}'}})
